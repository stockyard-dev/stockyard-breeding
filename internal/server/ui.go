...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Breeding</title>
...
<div class="hdr"><h1><span>&#9670;</span> BREEDING</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('animals')">Animals</div><div class="tab" onclick="switchTab('litters')">Litters</div><div class="tab" onclick="switchTab('health_records')">Health Records</div></div><div class="tab-content active" id="tab-animals">
<div class="stats" id="stats-animals"></div>
<div class="toolbar">
<input class="search" id="search-animals" placeholder="Search..." oninput="renderRes('animals')"><select class="filter-sel" id="filter-animals-species" onchange="renderRes('animals')"><option value="">All Species</option><option value="Dog">Dog</option><option value="Cat">Cat</option><option value="Horse">Horse</option><option value="Cattle">Cattle</option><option value="Poultry">Poultry</option><option value="Rabbit">Rabbit</option><option value="Other">Other</option></select><select class="filter-sel" id="filter-animals-sex" onchange="renderRes('animals')"><option value="">All Sex</option><option value="Male">Male</option><option value="Female">Female</option></select><select class="filter-sel" id="filter-animals-status" onchange="renderRes('animals')"><option value="">All Status</option><option value="Active">Active</option><option value="Retired">Retired</option><option value="Sold">Sold</option><option value="Deceased">Deceased</option></select></div>
<div class="count-label" id="count-animals"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Name</th><th>Species</th><th>Breed</th><th>Sex</th><th>Date of Birth</th><th>Registration #</th><th>Sire ID</th><th>Dam ID</th><th>Color/Markings</th><th>Status</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-animals"></tbody></table></div></div><div class="tab-content" id="tab-litters">
<div class="stats" id="stats-litters"></div>
<div class="toolbar">
<input class="search" id="search-litters" placeholder="Search..." oninput="renderRes('litters')"></div>
<div class="count-label" id="count-litters"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Sire ID</th><th>Dam ID</th><th>Date Born</th><th>Count</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-litters"></tbody></table></div></div><div class="tab-content" id="tab-health_records">
<div class="stats" id="stats-health_records"></div>
<div class="toolbar">
<input class="search" id="search-health_records" placeholder="Search..." oninput="renderRes('health_records')"><select class="filter-sel" id="filter-health_records-record_type" onchange="renderRes('health_records')"><option value="">All Type</option><option value="Vaccination">Vaccination</option><option value="Checkup">Checkup</option><option value="Treatment">Treatment</option><option value="Surgery">Surgery</option><option value="Test">Test</option></select></div>
<div class="count-label" id="count-health_records"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Animal ID</th><th>Type</th><th>Date</th><th>Description</th><th>Vet</th><th>Cost ($)</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-health_records"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="animals";var resCfg={"animals":{d:"Animals",f:[{n:"name",l:"Name",t:"text",r:true,o:[]},{n:"species",l:"Species",t:"select",r:false,o:["Dog","Cat","Horse","Cattle","Poultry","Rabbit","Other"]},{n:"breed",l:"Breed",t:"text",r:false,o:[]},{n:"sex",l:"Sex",t:"select",r:false,o:["Male","Female"]},{n:"date_of_birth",l:"Date of Birth",t:"date",r:false,o:[]},{n:"registration_number",l:"Registration #",t:"text",r:false,o:[]},{n:"sire_id",l:"Sire ID",t:"text",r:false,o:[]},{n:"dam_id",l:"Dam ID",t:"text",r:false,o:[]},{n:"color",l:"Color/Markings",t:"text",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Active","Retired","Sold","Deceased"]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},"litters":{d:"Litters",f:[{n:"sire_id",l:"Sire ID",t:"text",r:true,o:[]},{n:"dam_id",l:"Dam ID",t:"text",r:true,o:[]},{n:"date_born",l:"Date Born",t:"date",r:true,o:[]},{n:"count",l:"Count",t:"integer",r:false,o:[]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},"health_records":{d:"Health Records",f:[{n:"animal_id",l:"Animal ID",t:"text",r:true,o:[]},{n:"record_type",l:"Type",t:"select",r:false,o:["Vaccination","Checkup","Treatment","Surgery","Test"]},{n:"date",l:"Date",t:"date",r:true,o:[]},{n:"description",l:"Description",t:"text",r:false,o:[]},{n:"vet_name",l:"Vet",t:"text",r:false,o:[]},{n:"cost",l:"Cost ($)",t:"number",r:false,o:[]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},};
